...
const ProjectsOnHomePage = () => {
  return (
    ...
    <div className='lg:pl-[50px] 2xl:pl-[120px] px-5 lg:px-0 mt-[-450px] lg:mt-[-500px] 2xl:mt-[-400px] z-40 relative '>
      <p className='font-custom font-normal text-left text-[#F3F4F4]'>PROJECTS</p>
      <div className='flex flex-col lg:flex-row justify-between lg:items-center'>
        <p className='text-[32px] lg:text-[64px] font-custom1 text-left text-[#F3F4F4]'>Our Project</p>
